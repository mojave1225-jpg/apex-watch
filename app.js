...
const state = {
  ...
  scores: { assets: 0, residency: 72, medical: 78, comms: 81, mobility: 67, security: 85 },
  apiReady: false,
};
...
function recalcMain() {
  ...
  const weights = { assets: 0.22, residency: 0.15, medical: 0.12, comms: 0.17, mobility: 0.15, security: 0.19 };
